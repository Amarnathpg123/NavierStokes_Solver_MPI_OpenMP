PROGRAM main
    ...
    ! mpifort nse3dMpiOpenmp.f90 -I./2decomp_fft/include -L./2decomp_fft/lib -l2decomp_fft -lm -fopenmp
    ...
    INTEGER(kind=4)				:: i, j, k, n, t, allocatestatus, ind, ierr, p_row=0, p_col=0, numprocs, myid, omp_get_max_threads
